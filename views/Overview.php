    		...
    		<div id="content">
    			...
    			<div class="centerform" style="margin-left:10%; margin-right:10%; padding:2%;">
                    ...
                    <strong>Huma Qaiser (H00145644)</strong>
                    	<p>Huma's section is the currency exchange calculator which is the home page of the application and the front end design of the application. The currency exchange calculator  uses the currency rates gotten from the currency exchange section to calculate an amount from on currency to another. It will also makes use of an IP address web service to get the current location of the user and provide the currency on the form automatically.</p>
